...
This kit contains a simple Android application that demonstrates OEM login via Smartcar's Android SDK.
...
Then, we can set these constants in `MainActivity.kt` -
```kotlin
